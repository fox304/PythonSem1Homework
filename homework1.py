...
while len(number_of_weekday) > 1 or not (48 < ord(number_of_weekday) < 56):  # запрет на ввод данных , отличных от цифр 1,2,3,4,5,6,7
    number_of_weekday = input("Совеную всё-таки ввести цифру от 1 до 7 , иначе день пролетит незаметно ")
